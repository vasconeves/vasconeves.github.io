...
image: "/posts/regression-title-imgv3.png"
tags: [Customer Loyalty, Machine Learning, Regression, Python]
---

We've been contacted by a client, a well-known grocery retailer, requiring consultancy to ascertain market level customer loyalty information from their database. Only about 50% of the database has this information. Here, we will use ML approaches to solve this problem.
...
<br>
The code below then produces a plot that visualizes the cross-validated accuracy with each potential number of features
...
<br>
This creates the plot below, which shows us that the highest cross-validated accuracy (0.8635) is actually when we include all eight of our original input variables.  This is marginally higher than 6 included variables, and 7 included variables.  We will continue on with all 8!
