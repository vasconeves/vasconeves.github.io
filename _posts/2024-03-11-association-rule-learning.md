...
In this project I show how to use Association Rule Learning to analyse the different relationships between products in the alcohol section of a well-known retail brand.
